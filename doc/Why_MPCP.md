...
For the protocol specification and implementation, see the [Machine Payment Control Protocol Specification](./protocol/mpcp.md) and the [MPCP Service README](../README.md).
