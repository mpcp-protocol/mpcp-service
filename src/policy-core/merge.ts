import type { Policy, PolicyStack, Rail, Asset, GeoCircle } from "./types.js";
...
function mergeGeoAllowlist(a: GeoCircle[] | undefined, b: GeoCircle[] | undefined): GeoCircle[] | undefined {
  if (a === undefined && b === undefined) return undefined;
  if (a === undefined) return b;
  if (b === undefined) return a;
  return b;
...
function mergeRailAllowlist(a: Rail[] | undefined, b: Rail[] | undefined): Rail[] | undefined {
  if (a === undefined && b === undefined) return undefined;
  if (a === undefined) return b;
  if (b === undefined) return a;
  const set = new Set(b);
...
function mergeAssetAllowlist(a: Asset[] | undefined, b: Asset[] | undefined): Asset[] | undefined {
  if (a === undefined && b === undefined) return undefined;
  if (a === undefined) return b;
  if (b === undefined) return a;
  const key = (x: Asset) =>
...
function mergeCapMin(a: string | undefined, b: string | undefined): string | undefined {
  if (a === undefined) return b;
  if (b === undefined) return a;
